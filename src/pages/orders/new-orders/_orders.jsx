                    ...
                    <div key={index} className="order-info">
                      <div className="item-info">
                        <div className="item-box">
                          ...
                          <p>
                            {item.quantity} x <span>{item.description}</span>
                          </p>
                        </div>
                      </div>
                    ...
                    <div>
                      <div className="progress-bar-container">
                        ...
                        <p className="progress-text">
                          {order.timer === 0
                            ? `Order Prepared (${formatTime(order.timer)})`
                        ...
                        <div className="need-more-time">
                          {!showAddTime[order.id] ? (
                            <div className="buttons">
                              <Button
                                className="need-time"
                                onClick={() => handleNeedMoreTime(order.id)}
                              >
                                Need more time?
                              </Button>
                              <Button
                            ...
                            <div className="more-time-btn">
                              ...
                              <div className="add-time-btn">
                                <div className="timer">
                                  <Button
                                    onClick={() =>
                                      handleAdditionalDecrement(order.id)
                                    }
                                  >
                                    <FaMinus />
                                  </Button>
                                  <span>
                                    {formatTime(additionalTime[order.id] || 0)}
                                  </span>
                                  <Button
                                    onClick={() =>
                                      handleAdditionalIncrement(order.id)
                                    }
                                  >
                                    <FaPlus />
                                  </Button>
